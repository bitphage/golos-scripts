...
def main():
    ...
    parser.add_argument('-t', '--type', default='market', choices=['market', 'forum'],
            help='bandwidth type to estimate. Market - transfers, forum - posting ops')
    parser.add_argument('-w', '--warning', default=99, type=float,
            help='exit with 1 error code whether bandwidth exceeded specified percent')
    parser.add_argument('account',
            help='specify account which bandwidth should be estimated')
