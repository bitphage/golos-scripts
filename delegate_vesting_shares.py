...
def main():
    ...
    parser.add_argument(
        '-g', '--gests', action='store_true', help='amount in GESTS (default: amount in Golos Power)')
    parser.add_argument('f',
            help='account name to delegate from'),
    parser.add_argument('to',
            help='account name to delegate to'),
    parser.add_argument('amount', type=float,
            help='amount (default: amount in Golos Power)'),
